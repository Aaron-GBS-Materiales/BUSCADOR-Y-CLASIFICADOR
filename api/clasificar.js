...
- Interpreta sinónimos y equivalencias industriales:
  ...
  * RELE = CONTACTOR = TEMPORIZADOR = RETARDO = INTERRUPTOR → FAM 3916
  * BREAKER = DISYUNTOR = PROTECCION ELECTRICA → FAM 3915
  * HERRAMIENTA = LLAVE = ALICATE → FAM 2711
  * EPP = CASCO = GUANTES = ARNES = PROTECCION PERSONAL → FAM 4618
  * LUBRICANTE = ACEITE = GRASA = ANTICORROSIVO → FAM 1512
  * SOLDADURA = ELECTRODO = ALAMBRE MIG → FAM 2327
  * EMPAQUE = SELLO = JUNTA = ORING → FAM 3118
